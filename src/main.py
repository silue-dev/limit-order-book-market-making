...
class MarketSimulator:
    ...
    def __init__(self, 
        ...
        self.default_user = 'me'

    def add_random_limit_orders(self, 
                                mid_price: Decimal, 
                                volume: float = 100.0,
                                std: float = 0.10, 
                                noise: float = 10.0) -> tuple[deque[int], deque[int]]:
        """
    ...
    def run(self, 
        ...
        """
        bid_ids, ask_ids = self.add_random_limit_orders(mid_price=Decimal(init_price))
...
class Server:
    ...
    def __init__(self, 
        ...
        @self.app.route('/add_market_order', methods=['POST'])
        def add_market_order():
            ...
            with self.sim.lock:
                take_order_dict = {'side': side, 
                                   ...
                                   'kind': 'market',
                                   'user': user}
                self.sim.ob.add_order(take_order_dict)
